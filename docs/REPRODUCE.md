...
> over the 8 recovery seeds** and the error bar at **every** step is the ±1 s.d. spread across those 8 seeds
> (`dE_hist_mean` / `dE_hist_std`, reconstructed from the full per-seed run log of job `da125f2ein7c73bcsqs0`).
