...
reproducible from them. The complete reproduction repository---source, data, figure scripts, and a master
reproduction notebook---is openly available at \url{https://github.com/nicolasbonilla/dynamical-spectral-functions-sqd}.
