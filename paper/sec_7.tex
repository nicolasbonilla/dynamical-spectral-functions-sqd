...
the shot budget $T$ that populates the support. It is easy to price the first two and to quote the
second as though it were a property of the model. It is not. This section reports
what each axis costs, states which of the three exponents belongs to the Hubbard chain and which
belongs to the question we put to it, and prices the third, which is usually left unpriced.
...
The two axes usually priced are the fraction and the absolute support, and that pair is easily called
the honest two-sided picture. There is a third, it is the one that binds, and it is the one priced
here.
