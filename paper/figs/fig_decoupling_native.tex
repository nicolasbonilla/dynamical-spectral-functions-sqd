...
\node[inkPrim,font=\scriptsize,anchor=north east,align=left] at (rel axis cs:0.985,0.97) {$U=1\to16$ along each curve\\within each sweep: $\rho=-1.000$\\pooled ($n=30$): $\rho=-0.109$\\(Simpson reversal)};
...
\addlegendentry{$(10{,}8)$}
\node[inkPrim,font=\scriptsize,anchor=north west,align=left] at (rel axis cs:0.02,0.97) {$\chi$ falls as $U$ rises\\within each sweep: $\rho=0.894$ to $1.000$\\pooled ($n=30$): $\rho=+0.569$\\(Simpson reversal)};
% ---- (d) Simpson panel ----
...
\node[dcPool,font=\scriptsize,anchor=north west,align=left] at (rel axis cs:0.035,0.578) {pooled ($n=30$): $\rho=+0.569$\\(Simpson reversal)};
\node[dcPool,font=\scriptsize,anchor=north west,align=left] at (rel axis cs:0.035,0.377) {pooled ($n=30$): $\rho=-0.109$\\(Simpson reversal)};
\end{groupplot}
\end{tikzpicture}
