...
\begin{tikzpicture}
\begin{groupplot}[group style={group size=2 by 1, horizontal sep=1.7cm}, height=9.5cm, paperaxis,
...
\node[black,font=\normalsize,anchor=north east,fill=white,fill opacity=0.7,text opacity=1,inner sep=1pt] at (axis cs:30.6,1.52) {chemical accuracy};
