...
We make the two surviving parts of Theorem~1 of v1--v2 precise. Fix the seed
...
obtained by drawing bitstrings, or that any Lanczos basis is well conditioned; it holds verbatim for
...
$d\mu$. They are not, and it reaches order $3$. This is the measurable content of the correction to the
published proof: identifying $A_{\mathcal S}$ with an order-$(K{+}1)$ Gauss rule misdescribes both the
object and its reach.
...
(median $1.67\times10^{-1}$), i.e.\ by $3.7\%$ to $84\%$ of $\lVert\phi\rVert^{2}$, with every one of
...
Conjecture~\ref{conj:geom} was asserted as a consequence of Eq.~\eqref{eq:momex} in v1--v2. It is not
...
$1$ as $\eta\to0^{+}$. That is the mechanism v1--v2 describes. It is not a derivation, and no $C(\eta)$
or $\rho(\eta)$ appears in v1--v2 or in the deposit.
...
origin while $A$ carries two at $\pm g$; by direct integration at $\eta=0.15$,
$\lVert A-A_{\mathcal K_0}\rVert_1=1.5197,\ 1.8352,\ 1.9503,\ 1.9832,\ 1.9943,\ 1.9974,\ 1.9984$ for
...
removes the circularity of the published form $T=O(\varepsilon^{-1}\log(|\mathcal S|/\delta))$, in
...
nothing is conceded by the repair.
...
Table~\ref{tab:moments}, and $0.43$ at $L=6$ and $0.33$ at $L=8$ on the periodic rings, all at
