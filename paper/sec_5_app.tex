...
pipeline, and none of the three is checked anywhere in the deposit of versions~1--2. We check all
...
\paragraph{Ranking, ties and support.} Two properties of the cut are declared with the protocol, a
tie-breaking defect having cost this work numbers before. No determinant of any of the four sectors
carries exactly zero accumulated Born weight, so the cut is never filled with configurations the
...
Above the support floor $\tfrac12+\tfrac1L$ of Sec.~\ref{sec:retraction}, on the other hand, the
ranking selects among determinants outside $\operatorname{supp}(\phi)$: at fraction $0.85$ that is
$30.2\%$ of $S$ at $L=6$, $36.9\%$ at $L=8$ and ${\approx}39.6\%$ at $L=10$. Those contribute nothing
