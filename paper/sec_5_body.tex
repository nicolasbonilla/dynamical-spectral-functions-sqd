...
at $L=8$, $10$, $12$ and $14$; at $L=6$ it is $296$ of $300$, the one size at which the
answer depends on the threshold---so
...
without which the projector is not a projector (App.~\ref{app:hyp} gives the measured defect). What
...
assumed~\cite{haydock1972,epperly2022}; App.~\ref{app:hyp} bounds what the depth cap does to
$\mathrm{FR}^{\ast}$.
...
this pipeline in App.~\ref{app:hyp}, along with the ranking, tie and support declarations of the cut.
...
Neither component is a frontier of the method: at fixed size the displacement is the looseness of the
proof; the position of the threshold near unity is geometry. Section~\ref{sec:nogo} closes the picture
