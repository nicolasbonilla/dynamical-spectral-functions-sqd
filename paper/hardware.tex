...
\begin{figure}[htbp]\centering\includegraphics[width=\textwidth]{figs/fig_circuit.pdf}
...
\begin{figure}[htbp]\centering\input{figs/fig_hardware_hero_frag.tex}
...
solid curve is the mean over $8$ recovery seeds on the cached device counts, and the error bar at every
step is the $\pm1$~s.d.\ spread across those $8$ seeds (starting together with the noiseless curve at
step~$0$, $31.1\pm4.0$~mHa, then separating as recovery proceeds to the converged
$0.59\pm0.14$~mHa; best seed $0.40$~mHa). The
...
\begin{figure}[htbp]\centering\includegraphics[width=0.7\textwidth]{figs/fig_noise_score.pdf}
...
\begin{figure}[htbp]\centering\input{figs/fig_noise_recovery_native.tex}
