...
solid curve is the configuration-recovery trajectory on the cached device counts; the error bar at the
converged point is the $\pm1$~s.d.\ spread over $8$ recovery seeds on the same counts
