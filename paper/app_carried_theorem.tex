...
$0.948$; the two pooled coefficients versions~1--2 quoted for that sweep, $\rho=0.57$ and $-0.11$, are
withdrawn with the rest of the pooling and are not the evidence here, Sec.~\ref{sec:nogo:chi}). Two caveats belong with that number. A rank correlation is not a statement of tightness,
