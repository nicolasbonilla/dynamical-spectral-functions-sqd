...
noise through valid-shot economy rather than quantum advantage, whereas a \emph{learned} generative
tail-completer does \emph{not} beat that classical baseline (Fig.~\ref{fig:gflow})---delimiting, not
