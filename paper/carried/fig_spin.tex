...
\begin{figure*}[tp]\centering\includegraphics[width=0.92\linewidth]{figs/fig_spinqw.pdf}
...
$S^{zz}(q{\to}0)\to0$ (total-$S^z$ conservation). The same bitstring-sampled primitive that targets $A(k,\omega)$ and $S(q,\omega)$ targets this collective response as well.}\label{fig:spin}\end{figure*}
