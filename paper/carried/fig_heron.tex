...
$U/t=8$), reconstructed from $350{,}000$ computational-basis bitstrings---$50{,}000$ from each of seven
circuits---sampled on \texttt{ibm\_fez} (TREX
...
simulation of the \emph{same} shallow circuit (dashed) is stranded at $29.5$~mHa. That contrast is not read here as device noise \emph{helping}: the
