...
\begin{figure*}[tp]\centering\includegraphics[width=\linewidth]{figs/fig_akw_native.pdf}
...
measure~\cite{golub2010} and not the Lehmann sum, so the word \emph{exact} is not used of it
here (Sec.~\ref{sm:physics})---the frequency- and momentum-resolved
...
In the thermodynamic limit the lower Hubbard band is spin--charge separated; at $L=12$ the plot is compatible with a narrow spinon-like branch (bandwidth $\pi J/2=0.79\,t$~\cite{descloizeaux1962}, $J=4t^2/U$; dashed,
