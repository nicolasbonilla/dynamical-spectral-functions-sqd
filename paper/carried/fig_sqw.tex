...
\begin{figure*}[tp]\centering\includegraphics[width=0.92\linewidth]{figs/fig_sqw.pdf}
...
not the Lehmann sum (Sec.~\ref{sec:physics}). Colour is the \emph{response intensity} $S(q,\omega)$ (units $1/t$): bright
