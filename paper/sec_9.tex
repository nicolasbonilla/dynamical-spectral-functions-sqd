...
the deposited artefacts against it---$831$ checks over $9\,846$ numeric assertions, exiting non-zero on
...
and six items are printed by name on every run: four known open defects, and two declared gaps in
its own coverage---the source of Fig.~\ref{fig:thm1iii-violation}, and the four artefacts behind
Table~\ref{tab:moments}, none of which survives in the deposit.
