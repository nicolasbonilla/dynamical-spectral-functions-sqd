...
\section{Counterexamples to the retracted bound, and the pooled sweep}
\label{app:counterex}

\paragraph{The three-level family.} Section~\ref{sec:retraction} exhibits a two-level instance forcing
the constant of the retracted bound~\eqref{eq:retracted} to its trivial value at $w_S=1$. With $w_S<1$
...
error to the retracted bound then diverges as $\delta^{-2}$ in the displacement $\delta$ of the
...
the retracted bound fails on $468$; among the $363$ with $w_S\ge0.99$ --- the regime versions~1--2
invoked --- it fails on all $363$, the mildest by a factor $2.10$, with $50$ of them carrying $w_S=1$
...
rows at $K_S=-1$ and $21$ at $w_S=1$ exactly; and violations of the retracted bound on $219$ of the
